...
def embed(source: [str],
    ...
    :param preprocess: Enable preprocessing of text.
    ...
    def embed_paths(file_paths, draw_pipeline=False):
        ...
        embedding_retriever_input = ["TextConverter", "PDFToTextConverter", "MarkdownConverter", "DocxConverter"]
        if preprocess:
            ...
            embedding_retriever_input = ["PreProcessor"]

        indexing_pipeline.add_node(component=embedding_retriever, name="EmbeddingRetriever", inputs=embedding_retriever_input)
